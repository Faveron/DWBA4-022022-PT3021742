    ...
    try:
        ...
        if flask.request.method == "POST":
            contatos[flask.request.form['email']] = {
                ...
                'resposta': flask.request.form.getlist('resposta')
            }
        db['contatos'] = contatos
        return flask.render_template('contato.html', contatos=contatos)
...
def Editar(email):
    try:
        ...
        return flask.render_template('editar.html', contato=contato)
    except Exception as e:
        logging.exception(e)
        return flask.render_template('contato.html')
