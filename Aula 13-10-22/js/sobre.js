class Dados extends React.Component {
    constructor() {
        super();
        this.nome = "Instituto Federal de Educação, Ciência e Tecnologia de São Paulo";
        this.endereco = "Rua Pedro Vicente, 625 - Canindé - São Paulo - SP - Brasil - Cep: 01109-010";
    }

    render() {
        return (
            <div>
                <p>O <b>{this.nome}</b> – é uma autarquia federal de ensino.</p>
                ...
                <p>Durante sua história, recebeu, também, os nomes de Escola Técnica Federal de São Paulo e Centro Federal de Educação
                    Tecnológica de São Paulo. Com a transformação em Instituto, em dezembro de 2008, passou a ter relevância de
                    universidade, destacando-se pela autonomia.</p>
                ...
                <p>Além dos cursos presenciais, o Instituto Federal de São Paulo oferece os cursos Técnicos em Administração e em
                    ...
                    Distância (EaD).</p>
                <p>O IFSP é organizado em diversos câmpus e possui mais de 40 mil alunos matriculados nas 36 unidades distribuídas pelo
                    estado de São Paulo.;</p>
                <p>Localizado em <b>{this.endereco}</b></p>
            </div>
        );
    }
}

ReactDOM.render(<Dados />, document.getElementById("texto"));
